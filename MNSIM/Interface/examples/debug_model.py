...
from MNSIM.Interface.utils.utils import load_sim_config
...
hardware_config = load_sim_config("../../../SimConfig.ini")
model_config_path = "resnet18.yaml"
dataset = ClassificationBaseDataset.get_class_("cifar10")(dataset_ini)
model = BaseModel.get_class_("yaml")(model_config_path, hardware_config, dataset)
...
output = model.get_key_structure()
print(output)
